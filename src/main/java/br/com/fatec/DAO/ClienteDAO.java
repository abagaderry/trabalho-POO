...
//variaveis auxiliares
    ...
    public boolean altera(Cliente model) throws SQLException {
        String sql = "UPDATE cliente SET nome = ?, datanasc = ?, cep = ?, endereco = ?, num_comp = ?, bairro = ?, cidade = ?, uf = ?, fone = ?, email = ?, usuario = ?, senha = ?"
        + "WHERE cpf = ?;";
        ...
        pst.setString(2, model.getDatanasc());
        pst.setString(3, model.getCep());
        pst.setString(4, model.getEndereco());
        pst.setString(5, model.getNum_comp());
        pst.setString(6, model.getBairro());
        pst.setString(7, model.getCidade());
        pst.setString(8, model.getUf());
        pst.setString(9, model.getFone());
        pst.setString(10, model.getEmail());
        pst.setString(11, model.getUsuario());
        pst.setString(12, model.getSenha());
        pst.setString(13, model.getCpf());
